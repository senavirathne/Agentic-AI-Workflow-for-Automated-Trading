...
VM_PROJECT_DIR=/opt/project
VM_VENV_ACTIVATE=/opt/project/.venv/bin/activate
VM_DEFAULT_SYMBOL=AAPL
VM_DEFAULT_LOOPS=1
VM_DEFAULT_MODE=live
VM_TIMER_ENABLED=false
VM_AUTO_SHUTDOWN=true
VM_LOG_DIR=/opt/project/logs
```
...
python -m project.cli run --mode live --symbol AAPL
```
...
```bash
tail -f /opt/project/logs/workflow_backtest_aapl_http_20260405T093243Z.log
```
